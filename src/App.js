...
function App() {
  return (
    <div className="App">
      ...
      <form id="survey-form">
        <label for="name-label" type="text" id="name-label">Name <input class="spaceneeded" id="name" placeholder="Write your name..." required></input></label>
        <label for="email-label" type="text" id="email-label">Email <input class="spaceneeded" id="email" type="email" placeholder="Write your email..." required></input></label>
        <label for="number-label" type="number" id="number-label">Age <input class="spaceneeded" id="number" type="number" min="10" max="120" placeholder="Choose your age..."></input></label>
